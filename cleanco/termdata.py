terms_by_type = {
   ...
   'Besloten Vennootschap met Beperkte Aansprakelijkheid': ['b.v.b.a' 'bvba.'],
   'Commanditaire Vennootschap': ['c.v.', 'cv'],
   'Compania Anonima': ['ca', 'c.a.'],
   'Commanditaire Vennootschap op Aandelen': ['cva', 'c.v.a.', 'cvoa', 'c.v.o.a.'],
   ...
   'Ednolichno Druzhestvo s Ogranichena Otgovornost': ['eood', 'e.o.o.d.'],
   'Etairia periorismenis evthinis': ['epe', 'e.p.e.'],
   'Entreprise Unipersonnelle à Responsabilité Limitée': ['eurl', 'e.u.r.l.'],
   'Gesellschaft burgerlichen Rechts': ['gbr', 'g.b.r.'],
   'Gewone Commanditaire Vennootschap': ['gcv' 'g.c.v.'],
   'Gesellschaft mit beschränkter haftung': ['gesmbh', 'g.e.s.m.b.h.'],
   ...
   'Kommanditgesellschaft auf Aktien': ['kgaa', 'k.g.a.a.'],
   ...
   'Sociedade por Quotas de Responsabilidade Limitada': ['ltda' 'ltda.'],
   'Limitée': ['Ltée.', 'Ltée'],
   ...
   'Druzhestvo s ogranichena otgovornost': ['ood', 'o.o.d.'],
   'Osaühing': ['oü', 'o.ü.'],
   'Osakeyhtiö': ['oy', 'oy.'],
   'Julkinen osakeyhtiö': ['oyj', 'oyj.'],
   'Proprietary Limited': ['p/l', 'p.l.'],
   'Public Company Limited by Shares': ['pc ltd', 'pc ltd.'],
   'Public Limited Company': ['plc', 'plc.'],
   'Penenaman Modal Asing': ['pma', 'p.m.a.'],
   'Penanaman Modal Dalam Negeri': ['pmdn', 'p.m.d.n.'],
   'Private Company limited by shares': ['prc', 'p.r.c.', 'prp. ltd.', 'prp ltd'],
   'Perseroan Terbuka': ['pt', 'pt.'],
   'Proprietary': ['pty.', 'pty'],
   'Riiklik Aktsiaselts': ['ras',	'r.a.s.'],
   'Részvénytársaság': ['rt', 'r.t.'],
   'Sociedad de Responsabilidad Limitada': ['s. de r.l.', 's.r.l.'],
   'Sociedad en Comandita': ['s. en c.', 's.c.'],
   'Sociedad en Nombre Colectivo': ['s. en n.c.', 'snc'],
   'Sociedade por Ações': ['s.a.', 'sa'],
   'Sociedad Anónima Inscrita de Capital Abierto': ['s.a.i.c.a.', 'saica'],
   'Sociedad en commandita': ['s.c.', 'sc'],
   'Sociedade em Comandita Simples': ['scs', 'scs'],
   'Sociedades Anônimas': ['s/a', 's.a.'],
   'Sociedad Anónima de Capital Variable': ['sa de cv', 's.a. de c.v.'],
   'Sociedad Anonima Financiera de Inversion': ['safi', 's.a.f.i.'],
   'Societa in Accomandita per Azioni': ['sapa', 's.a.p.a.'],
   'Société à responsabilité limitée': ['sarl', 's.a.r.l.'],
   'Societá in Accomandita Semplice': ['sas', 's.a.s.'],
   'Société civile': ['sc', 's.c.'],
   'Societate in còmandita pe actiuni': ['sca', 's.c.a.'],
   'Sociedade em Conta de Participacao': ['scp', 's.c.p.'],
   'Societate in comandita simpla': ['scs', 's.c.s.'],
   'Sendirian Berhad': ['sdn bhd', 'sdn bhd.'],
   'Société en Nom Collectif': ['senc', 's.e.n.c.'],
   'Sociedade gestora de participações sociais': ['sgps', 's.g.p.s.'],
   'Spólka komandytowa': ['sk', 's.k.'],
   'Société de Participation Financière': ['soparfi'],
   'Societe en participation': ['sp', 's.p.'],
   'Spólka z ograniczona odpowiedzialnością': ['sp. z.o.o.'],
   'Società per Azioni': ['spa', 's.p.a.'],
   'Spolecnost s rucenim omezeným': ['spol s.r.o.', 'spol'],
   'Société Privée à Responsabilité Limitée': ['sprl', 's.p.r.l.'],
